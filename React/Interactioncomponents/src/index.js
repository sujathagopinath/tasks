...
class Salary extends React.Component {
    ...
    updatedsalary = () => {
        let salary = parseInt(this.irefs.basic.value) + parseInt(this.irefs.hra.value) + parseInt(this.inputrefs.SpecialAllowances.value);
...
class App extends React.Component {
    ...
    render() {
        return <div>
            ...
            <button onClick={this.update}>Update</button><br />
        </div>;
    }
}
...
class Mount extends React.Component {
    ...
    render() {
        ...
        return <div>
            ...
            <button onClick={this.setState({ data: !this.state.data })}>Unmount</button> */}
